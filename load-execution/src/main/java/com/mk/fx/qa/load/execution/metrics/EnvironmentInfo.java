...
/**
 * Utility class to retrieve environment information such as the host name and the user who
...
public final class EnvironmentInfo {
  ...
  /**
   * Retrieves the user who triggered the execution, either from environment variables or system
   * properties.
   *
