...
/**
 * Represents the live metrics of a task, including its configuration and current state.
 * This class is used to provide real-time feedback on the task's execution.
 */
@Data
