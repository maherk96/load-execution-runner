...
class WebSocketTimeoutFailureTest {
  ...
  void setUp() throws Exception {
    ...
    server.setPongEnabled(false); // do not respond with pong so awaitPattern times out
    server.start();
  ...
  @Test
  void closedModel_timeoutIsRecordedAsFailure() throws Exception {
    ...
    List<Map<String, Object>> messages =
        List.of(
            Map.of(
                ...
                "text", "ping",
                "awaitPattern", "pong",
                "awaitTimeoutMs", 50), // small timeout to trigger timeout failure
